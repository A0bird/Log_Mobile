 ...
 */
public class MyRecordWriter extends RecordWriter<StatsLocationDimension, ReduceOutPUtWritable> {
    ...
    @Override
    public void write(StatsLocationDimension key, ReduceOutPUtWritable value) throws IOException, InterruptedException {
            //判断key ，value 是否为空
