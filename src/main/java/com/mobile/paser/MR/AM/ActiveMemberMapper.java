 ...
 */
public class ActiveMemberMapper extends Mapper<LongWritable,Text,StatsUserDiemension,TimeOutPutWriteable> {
    public static final Logger logger=Logger.getLogger(ActiveMemberMapper.class);
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        outPutWriteable.setId(split[8]);
        outPutWriteable.setTime(Long.valueOf(split[24]));

        //k->KpiDimension
        // kpi browser_new_user
        KpiDimension kpiDimension = new KpiDimension(kpiTypeEnum.BROWSER_ACTIVE_MEMBER.kpiName);
        ...
        //no kpi new_user
        KpiDimension kpinewUser = new KpiDimension(kpiTypeEnum.ACTIVE_MEMBER.kpiName);
