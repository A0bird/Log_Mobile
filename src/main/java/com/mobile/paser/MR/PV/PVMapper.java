 ...
 */
public class PVMapper extends Mapper<LongWritable,Text,StatsUserDiemension,TimeOutPutWriteable> {
    public static final Logger logger=Logger.getLogger(PVMapper.class);
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        KpiDimension kpiDimension = new KpiDimension(kpiTypeEnum.PV_BROWSER.kpiName);
